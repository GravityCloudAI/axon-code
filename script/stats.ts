...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/sst/axoncode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for sst/axoncode...\n")
...
console.log("Fetching npm all-time downloads for axoncode-ai...\n")
const npmDownloads = await fetchNpmDownloads("axoncode-ai")
