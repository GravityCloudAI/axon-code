---
title: IDE
description: The axoncode extension for VS Code, Cursor, and other IDEs
---

axoncode integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `axoncode` in the terminal to get started.
...
To install axoncode on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `axoncode` - the extension installs automatically
...
Search for **axoncode** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `axoncode` in the integrated terminal.
