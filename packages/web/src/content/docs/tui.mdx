---
title: TUI
description: Using the axoncode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

axoncode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running axoncode starts the TUI for the current directory.
...
When using the axoncode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Exit axoncode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your axoncode config file.
