...
axoncode has a list of keybinds that you can customize through the axoncode config.
...
axoncode uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
