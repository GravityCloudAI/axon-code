---
title: Zen
description: Curated list of models provided by axoncode.
---
...
axoncode zen is a list of tested and verified models provided by the axoncode team.

:::note
axoncode zen is currently in beta.
:::

Zen works like any other provider in axoncode. You login to axoncode zen and get
...
:::tip
We tested a select group of models and providers that work well with axoncode.
:::
...
axoncode zen is an AI gateway that gives you access to these models.

---

## How it works

axoncode zen works like any other provider in axoncode.

1. You sign in to **<a href={console}>axoncode zen</a>**, add your billing
   details, and copy your API key.
2. You run `axoncode auth login`, select axoncode, and paste your API key.
...
| ---------------- | ---------------- | --------------------------------------------- | --------------------------- |
| GPT 5            | gpt-5            | `https://axoncode.ai/zen/v1/responses`        | `@ai-sdk/openai`            |
| GPT 5 Codex      | gpt-5-codex      | `https://axoncode.ai/zen/v1/responses`        | `@ai-sdk/openai`            |
| Claude Sonnet 4  | claude-sonnet-4  | `https://axoncode.ai/zen/v1/messages`         | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5 | claude-3-5-haiku | `https://axoncode.ai/zen/v1/messages`         | `@ai-sdk/anthropic`         |
| Claude Opus 4.1  | claude-opus-4-1  | `https://axoncode.ai/zen/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3 Coder 480B | qwen3-coder      | `https://axoncode.ai/zen/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Grok Code Fast 1 | grok-code        | `https://axoncode.ai/zen/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2          | kimi-k2          | `https://axoncode.ai/zen/v1/chat/completions` | `@ai-sdk/openai-compatible` |
...
- Grok Code Fast 1 is currently free on axoncode for a limited time. The xAI team is using this time to collect feedback and improve Grok Code.
- Code Supernova is a stealth model that's free on axoncode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with axoncode as well.
