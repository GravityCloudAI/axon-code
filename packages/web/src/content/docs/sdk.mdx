---
title: SDK
description: Type-safe JS client for axoncode server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The axoncode JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control axoncode programmatically.
...
You can also programmatically start an axoncode server:

```javascript
import { createaxoncodeServer } from "@opencode-ai/sdk"
...
You can pass a configuration object to customize server behavior. The server still picks up your `axoncode.json`, but you can override or add configuration inline:
...
const textResults = await client.find.text({
  query: { pattern: "function.*axoncode" },
})
