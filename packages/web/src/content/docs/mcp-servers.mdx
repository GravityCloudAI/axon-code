...
You can add external tools to axoncode using the _Model Context Protocol_, or MCP. axoncode supports both:
...
You can define MCP servers in your axoncode config under `mcp`.
...
```json title="axoncode.json" {11, 14-17}
{
  "$schema": "https://axoncode.ai/config.json",
  "mcp": {
    "my-mcp": {
