...
if defined axoncode_BIN_PATH (
    set "resolved=%axoncode_BIN_PATH%"
    goto :execute
)
...
set "name=axoncode-!platform!-!arch!"
set "binary=axoncode.exe"
...
:not_found
echo It seems that your package manager failed to install the right version of the axoncode CLI for your platform. You can try manually installing the "%name%" package >&2
exit /b 1
